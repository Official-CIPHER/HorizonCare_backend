...
// get all the doctors list for displaying on frontend
...
// API to get all the appointments for the doctor in doctor panel
...
const doctorDashboard = async(req,res) => {
  try {
    ...
    // calculate earning when appointments is completed or payment is done
